...
SOURCES+=\
	$(wildcard $(CY_AFR_ROOT)/mqtt_memfault_project/demo/dev_mode_key_provisioning/src/*.c)

INCLUDES+=\
	$(CY_AFR_ROOT)/mqtt_memfault_project/demo/dev_mode_key_provisioning/include

ifeq ($(CY_AFR_IS_TESTING), 0)
SOURCES+=\
	$(CY_AFR_ROOT)/mqtt_memfault_project/demo/demo_runner/aws_demo.c\
	$(CY_AFR_ROOT)/mqtt_memfault_project/demo/demo_runner/aws_demo_version.c\
	$(CY_AFR_ROOT)/mqtt_memfault_project/demo/demo_runner/iot_demo_freertos.c\
	$(CY_AFR_ROOT)/mqtt_memfault_project/demo/demo_runner/iot_demo_runner.c\
	$(CY_AFR_ROOT)/mqtt_memfault_project/demo/common/http_demo_helpers/http_demo_utils.c\
	$(CY_AFR_ROOT)/mqtt_memfault_project/demo/common/mqtt_demo_helpers/mqtt_demo_helpers.c\
	$(CY_AFR_ROOT)/mqtt_memfault_project/demo/common/pkcs11_helpers/pkcs11_helpers.c\
	$(wildcard $(CY_AFR_ROOT)/mqtt_memfault_project/demo/memfault/*.c)\
	$(wildcard $(CY_AFR_ROOT)/mqtt_memfault_project/demo/network_manager/*.c)

INCLUDES+=\
	$(CY_EXTAPP_PATH)/common\
	$(CY_AFR_ROOT)/mqtt_memfault_project/demo/https\
	$(CY_AFR_ROOT)/mqtt_memfault_project/demo/include\
	$(CY_AFR_ROOT)/mqtt_memfault_project/demo/network_manager\
	$(CY_AFR_ROOT)/mqtt_memfault_project/demo/tcp\
	$(CY_AFR_ROOT)/mqtt_memfault_project/demo/common/http_demo_helpers\
	$(CY_AFR_ROOT)/mqtt_memfault_project/demo/common/mqtt_demo_helpers\
	$(CY_AFR_ROOT)/mqtt_memfault_project/demo/common/pkcs11_helpers\
	$(CY_AFR_ROOT)/mqtt_memfault_project/demo/coreMQTT_Agent\
	$(CY_AFR_ROOT)/mqtt_memfault_project/demo/device_defender_for_aws\
	$(CY_AFR_ROOT)/mqtt_memfault_project/demo/device_defender_for_aws/metrics_collector/lwip
else
